...
class BoxAgent(Agent):
    ...
    def find_free_position(self, agent, active_agent_path):
        # Implementar lógica para encontrar una posición libre fuera del path del activeAgent y empujable
        directions = [(0, -1), (0, 1), (-1, 0), (1, 0)] # Movimientos ortogonales

        for direction in directions:
            new_position = (agent.pos[0] + direction[0], agent.pos[1] + direction[1])
